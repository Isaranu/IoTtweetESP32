...
class IoTtweetESP32
{
  public:
    ...
    String getVersion();
    String WriteDashboard(const char *userid, const char *key, int slot0, int slot1, int slot2, int slot3, const char *tw, const char *twpb);
  ...
  private:
    ...
    int _slot0, _slot1, _slot2, _slot3;
